...
export default function TemplateTester() {
  ...
  return (
    <div className="p-6">
      <div className="flex gap-4 mb-6 p-4 bg-gray-100 z-10 rounded-lg">
        <button 
          onClick={() => setCurrentTemplate('bento')}
          className="px-4 py-2 bg-blue-500 z-10 text-white rounded"
        >
          Bento
        </button>
        <button 
          onClick={() => setCurrentTemplate('glassmorphism')}
          className="px-4 py-2 bg-purple-500 z-10  text-white rounded"
        >
          Glassmorphism
        </button>
        <button 
